# Generated from grammars/VisualBasic6Parser.g4 by ANTLR 4.13.1
from antlr4 import *
...
class VisualBasic6ParserListener(ParseTreeListener):
    ...
    def enterModuleReferenceValue(
        self, ctx: VisualBasic6Parser.ModuleReferenceValueContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#moduleReferenceValue.
    def exitModuleReferenceValue(
        self, ctx: VisualBasic6Parser.ModuleReferenceValueContext
    ):
        pass

    # Enter a parse tree produced by VisualBasic6Parser#moduleReferenceComponent.
    def enterModuleReferenceComponent(
    ...
    def exitModuleReferenceComponent(
        self, ctx: VisualBasic6Parser.ModuleReferenceComponentContext
    ):
        pass
    ...
    def enterModuleConfigElement(
        self, ctx: VisualBasic6Parser.ModuleConfigElementContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#moduleConfigElement.
    def exitModuleConfigElement(
        self, ctx: VisualBasic6Parser.ModuleConfigElementContext
    ):
        pass
    ...
    def enterOptionPrivateModuleStmt(
    ...
    def enterCp_ControlIdentifier(
        self, ctx: VisualBasic6Parser.Cp_ControlIdentifierContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#cp_ControlIdentifier.
    def exitCp_ControlIdentifier(
        self, ctx: VisualBasic6Parser.Cp_ControlIdentifierContext
    ):
        pass
    ...
    def enterEnumerationStmt_Constant(
        self, ctx: VisualBasic6Parser.EnumerationStmt_ConstantContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#enumerationStmt_Constant.
    def exitEnumerationStmt_Constant(
        self, ctx: VisualBasic6Parser.EnumerationStmt_ConstantContext
    ):
        pass
    ...
    def enterMacroElseIfBlockStmt(
        self, ctx: VisualBasic6Parser.MacroElseIfBlockStmtContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#macroElseIfBlockStmt.
    def exitMacroElseIfBlockStmt(
        self, ctx: VisualBasic6Parser.MacroElseIfBlockStmtContext
    ):
        pass

    # Enter a parse tree produced by VisualBasic6Parser#macroElseBlockStmt.
    def enterMacroElseBlockStmt(
        self, ctx: VisualBasic6Parser.MacroElseBlockStmtContext
    ):
        pass
    ...
    def enterOutputList_Expression(
        self, ctx: VisualBasic6Parser.OutputList_ExpressionContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#outputList_Expression.
    def exitOutputList_Expression(
        self, ctx: VisualBasic6Parser.OutputList_ExpressionContext
    ):
        pass
    ...
    def enterECS_MemberProcedureCall(
    ...
    def exitImplicitCallStmt_InBlock(
        self, ctx: VisualBasic6Parser.ImplicitCallStmt_InBlockContext
    ):
        pass
    ...
    def enterICS_S_DictionaryCall(
        self, ctx: VisualBasic6Parser.ICS_S_DictionaryCallContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#iCS_S_DictionaryCall.
    def exitICS_S_DictionaryCall(
        self, ctx: VisualBasic6Parser.ICS_S_DictionaryCallContext
    ):
        pass
    ...
    def enterDictionaryCallStmt(
        self, ctx: VisualBasic6Parser.DictionaryCallStmtContext
    ):
        pass
    ...
    def enterAmbiguousIdentifier(
        self, ctx: VisualBasic6Parser.AmbiguousIdentifierContext
    ):
        pass

    # Exit a parse tree produced by VisualBasic6Parser#ambiguousIdentifier.
    def exitAmbiguousIdentifier(
        self, ctx: VisualBasic6Parser.AmbiguousIdentifierContext
    ):
        pass
    ...
    def enterComparisonOperator(
        self, ctx: VisualBasic6Parser.ComparisonOperatorContext
    ):
        pass
    ...
    def enterPublicPrivateVisibility(
